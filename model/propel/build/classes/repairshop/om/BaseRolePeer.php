...
abstract class BaseRolePeer {
	...
	const CLASS_DEFAULT = 'repairshop.Role';
	...
	protected static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'Name', 'Notes', 'Type', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'name', 'notes', 'type', ),
		BasePeer::TYPE_COLNAME => array (self::ID, self::NAME, self::NOTES, self::TYPE, ),
		BasePeer::TYPE_RAW_COLNAME => array ('ID', 'NAME', 'NOTES', 'TYPE', ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'name', 'notes', 'type', ),
	...
	protected static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'Name' => 1, 'Notes' => 2, 'Type' => 3, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'name' => 1, 'notes' => 2, 'type' => 3, ),
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::NAME => 1, self::NOTES => 2, self::TYPE => 3, ),
		BasePeer::TYPE_RAW_COLNAME => array ('ID' => 0, 'NAME' => 1, 'NOTES' => 2, 'TYPE' => 3, ),
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'name' => 1, 'notes' => 2, 'type' => 3, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, )
	);
	...
	public static function addSelectColumns(Criteria $criteria, $alias = null)
	{
		if (null === $alias) {
			...
			$criteria->addSelectColumn(RolePeer::NOTES);
			$criteria->addSelectColumn(RolePeer::TYPE);
		} else {
	...
	protected static function doOnDeleteCascade(Criteria $criteria, PropelPDO $con)
	{
		...
		foreach ($objects as $obj) {
			...
			$criteria->add(RoleactionPeer::ROLE_ID, $obj->getId());
