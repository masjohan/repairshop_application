...
/**
 * Base class that represents a row from the 'RepairOrderCode' table.
 *
 * 
 *
 * @package    propel.generator.repairshop.om
 */
abstract class BaseRepairordercode extends BaseObject  implements Persistent
{

	/**
	 * Peer class name
	 */
	const PEER = 'RepairordercodePeer';

	/**
	 * The Peer class.
	 * Instance provides a convenient way of calling static methods on a class
	 * that calling code may not be able to identify.
	 * @var        RepairordercodePeer
	 */
	 ...
	 * @return     Repairordercode The current object (for fluent API support)
	 */
	public function setId($v)
	{
		...
		if ($this->id !== $v) {
			$this->id = $v;
			$this->modifiedColumns[] = RepairordercodePeer::ID;
		}
	...
	public function setCode($v)
	{
		...
		if ($this->code !== $v) {
			$this->code = $v;
			$this->modifiedColumns[] = RepairordercodePeer::CODE;
		}
	...
	public function setSystem($v)
	{
		...
		if ($this->system !== $v) {
			$this->system = $v;
			$this->modifiedColumns[] = RepairordercodePeer::SYSTEM;
		}
	...
	public function setDesc($v)
	{
		...
		if ($this->desc !== $v) {
			$this->desc = $v;
			$this->modifiedColumns[] = RepairordercodePeer::DESC;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->system = ($row[$startcol + 2] !== null) ? (string) $row[$startcol + 2] : null;
			...
			return $startcol + 4; // 4 = RepairordercodePeer::NUM_HYDRATE_COLUMNS.

		} catch (Exception $e) {
			throw new PropelException("Error populating Repairordercode object", $e);
		}
	}
	...
	public function reload($deep = false, PropelPDO $con = null)
	{
		...
		$stmt = RepairordercodePeer::doSelectStmt($this->buildPkeyCriteria(), $con);
	...
	public function save(PropelPDO $con = null)
	{
		...
		try {
			...
			if ($ret) {
				...
				$this->postSave($con);
				RepairordercodePeer::addInstanceToPool($this);
			} else {
				$affectedRows = 0;
			}
			$con->commit();
		...
		if (!$this->alreadyInSave) {
			...
			if ($this->isModified()) {
				if ($this->isNew()) {
					...
					if ($criteria->keyContainsValue(RepairordercodePeer::ID) ) {
					...
					$affectedRows = RepairordercodePeer::doUpdate($this, $con);
				}
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if (($retval = RepairordercodePeer::doValidate($this, $columns)) !== true) {
	...
	{
		$pos = RepairordercodePeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
	...
	{
		if (isset($alreadyDumpedObjects['Repairordercode'][$this->getPrimaryKey()])) {
			return '*RECURSION*';
		}
		$alreadyDumpedObjects['Repairordercode'][$this->getPrimaryKey()] = true;
		$keys = RepairordercodePeer::getFieldNames($keyType);
		$result = array(
			$keys[0] => $this->getId(),
			$keys[1] => $this->getCode(),
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(RepairordercodePeer::ID)) $criteria->add(RepairordercodePeer::ID, $this->id);
		if ($this->isColumnModified(RepairordercodePeer::CODE)) $criteria->add(RepairordercodePeer::CODE, $this->code);
		if ($this->isColumnModified(RepairordercodePeer::SYSTEM)) $criteria->add(RepairordercodePeer::SYSTEM, $this->system);
		if ($this->isColumnModified(RepairordercodePeer::DESC)) $criteria->add(RepairordercodePeer::DESC, $this->desc);
	...
	{
		$criteria = new Criteria(RepairordercodePeer::DATABASE_NAME);
		$criteria->add(RepairordercodePeer::ID, $this->id);
	 ...
	 * objects.
	 *
	 * @param      object $copyObj An object of Repairordercode (or compatible) type.
	 ...
	 *
	 * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
	 * @return     Repairordercode Clone of current object.
	 * @throws     PropelException
	 */
	 ...
	 *
	 * @return     RepairordercodePeer
	 */
	public function getPeer()
	{
		if (self::$peer === null) {
			self::$peer = new RepairordercodePeer();
		}
		return self::$peer;
	}
	 ...
	 * If this Repairordercode is new, it will return
	 ...
	 * Otherwise if this Repairordercode is new, it will return
	 * an empty collection; or if this Repairordercode has previously
	 * been saved, it will retrieve related Repairorderitems from storage.
	 *
	 * This method is protected by default in order to keep the public
	 * api reasonable.  You can provide public methods for those you
	 * actually need in Repairordercode.
	 *
	 * @param      Criteria $criteria optional Criteria object to narrow the query
	 * @param      PropelPDO $con optional connection object
	 ...
	 * @return     PropelCollection|array Repairorderitem[] List of Repairorderitem objects
	 */
	public function getRepairorderitemsJoinRepairorder($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		$query = RepairorderitemQuery::create(null, $criteria);
		$query->joinWith('Repairorder', $join_behavior);
	...
	{
		return (string) $this->exportTo(RepairordercodePeer::DEFAULT_STRING_FORMAT);
	}
