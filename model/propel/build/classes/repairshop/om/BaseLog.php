...
abstract class BaseLog extends BaseObject  implements Persistent
{
	...
	public function setAction($v)
	{
		...
		if ($this->action !== $v) {
			$this->action = $v;
			$this->modifiedColumns[] = LogPeer::ACTION;
		}
	...
	public function setTableName($v)
	{
		...
		if ($this->table_name !== $v) {
			$this->table_name = $v;
			$this->modifiedColumns[] = LogPeer::TABLE_NAME;
		}
	...
	/**
	 * Set the value of [table_id] column.
	 * 
	 * @param      int $v new value
	 * @return     Log The current object (for fluent API support)
	 */
	public function setTableId($v)
	{
		...
		if ($this->table_id !== $v) {
			$this->table_id = $v;
			$this->modifiedColumns[] = LogPeer::TABLE_ID;
		}
	...
	public function setNotes($v)
	{
		...
		if ($this->notes !== $v) {
			$this->notes = $v;
			$this->modifiedColumns[] = LogPeer::NOTES;
		}
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(LogPeer::ACTION)) $criteria->add(LogPeer::ACTION, $this->action);
		if ($this->isColumnModified(LogPeer::TABLE_NAME)) $criteria->add(LogPeer::TABLE_NAME, $this->table_name);
		if ($this->isColumnModified(LogPeer::TABLE_ID)) $criteria->add(LogPeer::TABLE_ID, $this->table_id);
		if ($this->isColumnModified(LogPeer::NOTES)) $criteria->add(LogPeer::NOTES, $this->notes);
