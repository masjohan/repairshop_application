...
/**
 * Base static class for performing query and update operations on the '_session' table.
 *
 * 
 *
...
abstract class BaseSessionPeer {
	...
	const CLASS_DEFAULT = 'repairshop.Session';
	...
	/** the column name for the DEVICE_KEY field */
	const DEVICE_KEY = '_session.DEVICE_KEY';

	/** the column name for the VALUE field */
	const VALUE = '_session.VALUE';

	/** the column name for the UPDATED_ON field */
	const UPDATED_ON = '_session.UPDATED_ON';
	...
	/**
	 * Method to invalidate the instance pool of all tables related to _session
	...
	/**
	 * Method to DELETE all rows from the _session table.
	 *
	 * @return     int The number of affected rows (if supported by underlying database driver).
	 */
