...
abstract class BaseRole extends BaseObject  implements Persistent
{
	...
	public function setNotes($v)
	{
		...
		if ($this->notes !== $v) {
			$this->notes = $v;
			$this->modifiedColumns[] = RolePeer::NOTES;
		}
	...
	public function setType($v)
	{
		...
		if ($this->type !== $v) {
			$this->type = $v;
			$this->modifiedColumns[] = RolePeer::TYPE;
		}
		...
		if (!$this->alreadyInSave) {
			...
			if ($this->isModified()) {
				if ($this->isNew()) {
					...
					if ($criteria->keyContainsValue(RolePeer::ID) ) {
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(RolePeer::NOTES)) $criteria->add(RolePeer::NOTES, $this->notes);
		if ($this->isColumnModified(RolePeer::TYPE)) $criteria->add(RolePeer::TYPE, $this->type);
