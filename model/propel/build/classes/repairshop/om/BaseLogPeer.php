...
abstract class BaseLogPeer {
	...
	const CLASS_DEFAULT = 'repairshop.Log';
	...
	public static function addSelectColumns(Criteria $criteria, $alias = null)
	{
		if (null === $alias) {
			...
			$criteria->addSelectColumn(LogPeer::ACTION);
			$criteria->addSelectColumn(LogPeer::TABLE_NAME);
			$criteria->addSelectColumn(LogPeer::TABLE_ID);
			$criteria->addSelectColumn(LogPeer::NOTES);
		} else {
