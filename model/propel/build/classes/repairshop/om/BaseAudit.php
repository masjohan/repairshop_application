...
abstract class BaseAudit extends BaseObject  implements Persistent
{
	...
	public function setWhen($v)
	{
		...
		if ($this->when !== null || $dt !== null) {
			...
			if ($currentDateAsString !== $newDateAsString) {
				...
				$this->modifiedColumns[] = AuditPeer::WHEN;
			}
	...
	public function setTableName($v)
	{
		...
		if ($this->table_name !== $v) {
			$this->table_name = $v;
			$this->modifiedColumns[] = AuditPeer::TABLE_NAME;
		}
	...
	public function setTableId($v)
	{
		...
		if ($this->table_id !== $v) {
			$this->table_id = $v;
			$this->modifiedColumns[] = AuditPeer::TABLE_ID;
		}
	...
	{
		if (isset($alreadyDumpedObjects['Audit'][$this->getPrimaryKey()])) {
			return '*RECURSION*';
		}
		$alreadyDumpedObjects['Audit'][$this->getPrimaryKey()] = true;
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(AuditPeer::WHEN)) $criteria->add(AuditPeer::WHEN, $this->when);
	...
	{
		return (string) $this->exportTo(AuditPeer::DEFAULT_STRING_FORMAT);
	}
