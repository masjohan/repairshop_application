...
/**
 * Base static class for performing query and update operations on the 'CalendarEvent' table.
 *
 * 
 *
...
abstract class BaseCalendareventPeer {
	...
	const CLASS_DEFAULT = 'repairshop.Calendarevent';
	...
	const FIRST_NAME = 'CalendarEvent.FIRST_NAME';

	/** the column name for the LAST_NAME field */
	const LAST_NAME = 'CalendarEvent.LAST_NAME';

	/** the column name for the PHONE field */
	const PHONE = 'CalendarEvent.PHONE';

	/** the column name for the NOTES field */
	const NOTES = 'CalendarEvent.NOTES';
	...
	protected static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'FirstName', 'LastName', 'Phone', 'Notes', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'firstName', 'lastName', 'phone', 'notes', ),
		BasePeer::TYPE_COLNAME => array (self::ID, self::FIRST_NAME, self::LAST_NAME, self::PHONE, self::NOTES, ),
		BasePeer::TYPE_RAW_COLNAME => array ('ID', 'FIRST_NAME', 'LAST_NAME', 'PHONE', 'NOTES', ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'first_name', 'last_name', 'phone', 'notes', ),
	...
	protected static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'FirstName' => 1, 'LastName' => 2, 'Phone' => 3, 'Notes' => 4, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'firstName' => 1, 'lastName' => 2, 'phone' => 3, 'notes' => 4, ),
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::FIRST_NAME => 1, self::LAST_NAME => 2, self::PHONE => 3, self::NOTES => 4, ),
		BasePeer::TYPE_RAW_COLNAME => array ('ID' => 0, 'FIRST_NAME' => 1, 'LAST_NAME' => 2, 'PHONE' => 3, 'NOTES' => 4, ),
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'first_name' => 1, 'last_name' => 2, 'phone' => 3, 'notes' => 4, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, )
	);
	...
	public static function addSelectColumns(Criteria $criteria, $alias = null)
	{
		if (null === $alias) {
			...
			$criteria->addSelectColumn(CalendareventPeer::FIRST_NAME);
			$criteria->addSelectColumn(CalendareventPeer::LAST_NAME);
			$criteria->addSelectColumn(CalendareventPeer::PHONE);
			$criteria->addSelectColumn(CalendareventPeer::NOTES);
		} else {
	...
	/**
	 * Method to invalidate the instance pool of all tables related to CalendarEvent
	...
	/**
	 * Method to DELETE all rows from the CalendarEvent table.
	 *
	 * @return     int The number of affected rows (if supported by underlying database driver).
	 */
	public static function doDeleteAll($con = null)
	{
		...
		try {
			...
			$con->beginTransaction();
			$affectedRows += CalendareventPeer::doOnDeleteCascade(new Criteria(CalendareventPeer::DATABASE_NAME), $con);
	 ...
	 */
	 public static function doDelete($values, PropelPDO $con = null)
	 {
		...
		try {
			...
			$c = clone $criteria;
			$affectedRows += CalendareventPeer::doOnDeleteCascade($c, $con);
	...
	protected static function doOnDeleteCascade(Criteria $criteria, PropelPDO $con)
	{
		...
		$objects = CalendareventPeer::doSelect($criteria, $con);
		foreach ($objects as $obj) {
			...
			$criteria->add(CalendarPeer::EVENT_ID, $obj->getId());
