...
abstract class BaseCalendarevent extends BaseObject  implements Persistent
{
	...
	public function setFirstName($v)
	{
		...
		if ($this->first_name !== $v) {
			$this->first_name = $v;
			$this->modifiedColumns[] = CalendareventPeer::FIRST_NAME;
		}
	...
	public function setLastName($v)
	{
		...
		if ($this->last_name !== $v) {
			$this->last_name = $v;
			$this->modifiedColumns[] = CalendareventPeer::LAST_NAME;
		}
	...
	public function setPhone($v)
	{
		...
		if ($this->phone !== $v) {
			$this->phone = $v;
			$this->modifiedColumns[] = CalendareventPeer::PHONE;
		}
	...
	public function setNotes($v)
	{
		...
		if ($this->notes !== $v) {
			$this->notes = $v;
			$this->modifiedColumns[] = CalendareventPeer::NOTES;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 5; // 5 = CalendareventPeer::NUM_HYDRATE_COLUMNS.
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(CalendareventPeer::FIRST_NAME)) $criteria->add(CalendareventPeer::FIRST_NAME, $this->first_name);
		if ($this->isColumnModified(CalendareventPeer::LAST_NAME)) $criteria->add(CalendareventPeer::LAST_NAME, $this->last_name);
		if ($this->isColumnModified(CalendareventPeer::PHONE)) $criteria->add(CalendareventPeer::PHONE, $this->phone);
		if ($this->isColumnModified(CalendareventPeer::NOTES)) $criteria->add(CalendareventPeer::NOTES, $this->notes);
