 ...
 *
 * @method     ShopQuery leftJoinCalendarresource($relationAlias = null) Adds a LEFT JOIN clause to the query using the Calendarresource relation
 * @method     ShopQuery rightJoinCalendarresource($relationAlias = null) Adds a RIGHT JOIN clause to the query using the Calendarresource relation
 * @method     ShopQuery innerJoinCalendarresource($relationAlias = null) Adds a INNER JOIN clause to the query using the Calendarresource relation
 *
...
abstract class BaseShopQuery extends ModelCriteria
{
	 ...
	 *
	 * @param     Calendarresource $calendarresource  the related object to use as filter
	 * @param     string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
	 *
	 * @return    ShopQuery The current query, for fluid interface
	 */
	public function filterByCalendarresource($calendarresource, $comparison = null)
	{
		if ($calendarresource instanceof Calendarresource) {
			return $this
				->addUsingAlias(ShopPeer::ID, $calendarresource->getShopId(), $comparison);
		} elseif ($calendarresource instanceof PropelCollection) {
			return $this
				->useCalendarresourceQuery()
					->filterByPrimaryKeys($calendarresource->getPrimaryKeys())
				->endUse();
		} else {
