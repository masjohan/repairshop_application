...
abstract class BaseSettingPeer {
	...
	const CLASS_DEFAULT = 'repairshop.Setting';
	...
	const ROLE_TYPE = 'Setting.ROLE_TYPE';
	...
	const MEMO = 'Setting.MEMO';

	/** the column name for the SYS_OVERRIDE field */
	const SYS_OVERRIDE = 'Setting.SYS_OVERRIDE';

	/** the column name for the USR_OVERRIDE field */
	const USR_OVERRIDE = 'Setting.USR_OVERRIDE';

	/** the column name for the USR_VALIDATOR field */
	const USR_VALIDATOR = 'Setting.USR_VALIDATOR';
	...
	protected static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'RoleType', 'Name', 'Value', 'Memo', 'SysOverride', 'UsrOverride', 'UsrValidator', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'roleType', 'name', 'value', 'memo', 'sysOverride', 'usrOverride', 'usrValidator', ),
		BasePeer::TYPE_COLNAME => array (self::ID, self::ROLE_TYPE, self::NAME, self::VALUE, self::MEMO, self::SYS_OVERRIDE, self::USR_OVERRIDE, self::USR_VALIDATOR, ),
		BasePeer::TYPE_RAW_COLNAME => array ('ID', 'ROLE_TYPE', 'NAME', 'VALUE', 'MEMO', 'SYS_OVERRIDE', 'USR_OVERRIDE', 'USR_VALIDATOR', ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'role_type', 'name', 'value', 'memo', 'sys_override', 'usr_override', 'usr_validator', ),
	...
	protected static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'RoleType' => 1, 'Name' => 2, 'Value' => 3, 'Memo' => 4, 'SysOverride' => 5, 'UsrOverride' => 6, 'UsrValidator' => 7, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'roleType' => 1, 'name' => 2, 'value' => 3, 'memo' => 4, 'sysOverride' => 5, 'usrOverride' => 6, 'usrValidator' => 7, ),
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::ROLE_TYPE => 1, self::NAME => 2, self::VALUE => 3, self::MEMO => 4, self::SYS_OVERRIDE => 5, self::USR_OVERRIDE => 6, self::USR_VALIDATOR => 7, ),
		BasePeer::TYPE_RAW_COLNAME => array ('ID' => 0, 'ROLE_TYPE' => 1, 'NAME' => 2, 'VALUE' => 3, 'MEMO' => 4, 'SYS_OVERRIDE' => 5, 'USR_OVERRIDE' => 6, 'USR_VALIDATOR' => 7, ),
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'role_type' => 1, 'name' => 2, 'value' => 3, 'memo' => 4, 'sys_override' => 5, 'usr_override' => 6, 'usr_validator' => 7, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, 6, 7, )
	);
	...
	public static function addSelectColumns(Criteria $criteria, $alias = null)
	{
		if (null === $alias) {
			...
			$criteria->addSelectColumn(SettingPeer::ROLE_TYPE);
			$criteria->addSelectColumn(SettingPeer::NAME);
			$criteria->addSelectColumn(SettingPeer::VALUE);
			$criteria->addSelectColumn(SettingPeer::MEMO);
			$criteria->addSelectColumn(SettingPeer::SYS_OVERRIDE);
			$criteria->addSelectColumn(SettingPeer::USR_OVERRIDE);
			$criteria->addSelectColumn(SettingPeer::USR_VALIDATOR);
		} else {
			...
			$criteria->addSelectColumn($alias . '.SYS_OVERRIDE');
			$criteria->addSelectColumn($alias . '.USR_OVERRIDE');
			$criteria->addSelectColumn($alias . '.USR_VALIDATOR');
		}
	}
	...
	{
		// Invalidate objects in SettingoverridePeer instance pool, 
	...
	public static function doDeleteAll($con = null)
	{
		...
		try {
			...
			$con->beginTransaction();
			$affectedRows += SettingPeer::doOnDeleteCascade(new Criteria(SettingPeer::DATABASE_NAME), $con);
	 ...
	 */
	 public static function doDelete($values, PropelPDO $con = null)
	 {
		...
		try {
			...
			$c = clone $criteria;
			$affectedRows += SettingPeer::doOnDeleteCascade($c, $con);
	...
	protected static function doOnDeleteCascade(Criteria $criteria, PropelPDO $con)
	{
		...
		$objects = SettingPeer::doSelect($criteria, $con);
		foreach ($objects as $obj) {


			// delete related Settingoverride objects
			$criteria = new Criteria(SettingoverridePeer::DATABASE_NAME);
			
			$criteria->add(SettingoverridePeer::SETTING_ID, $obj->getId());
			$affectedRows += SettingoverridePeer::doDelete($criteria, $con);
		}
		return $affectedRows;
	}
