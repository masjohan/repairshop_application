...
abstract class BaseCalendarPeer {
	...
	const USER_ID = 'Calendar.USER_ID';
	...
	protected static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'UserId', 'SlotId', 'EventId', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'userId', 'slotId', 'eventId', ),
		BasePeer::TYPE_COLNAME => array (self::ID, self::USER_ID, self::SLOT_ID, self::EVENT_ID, ),
		BasePeer::TYPE_RAW_COLNAME => array ('ID', 'USER_ID', 'SLOT_ID', 'EVENT_ID', ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'user_id', 'slot_id', 'event_id', ),
	...
	protected static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'UserId' => 1, 'SlotId' => 2, 'EventId' => 3, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'userId' => 1, 'slotId' => 2, 'eventId' => 3, ),
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::USER_ID => 1, self::SLOT_ID => 2, self::EVENT_ID => 3, ),
		BasePeer::TYPE_RAW_COLNAME => array ('ID' => 0, 'USER_ID' => 1, 'SLOT_ID' => 2, 'EVENT_ID' => 3, ),
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'user_id' => 1, 'slot_id' => 2, 'event_id' => 3, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, )
	);
	...
	public static function addSelectColumns(Criteria $criteria, $alias = null)
	{
		if (null === $alias) {
			...
			$criteria->addSelectColumn(CalendarPeer::USER_ID);
	...
	public static function doCountJoinUser(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		$criteria->addJoin(CalendarPeer::USER_ID, UserPeer::ID, $join_behavior);
	...
	/**
	 * Selects a collection of Calendar objects pre-filled with their User objects.
	 * @param      Criteria  $criteria
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
	...
	public static function doSelectJoinUser(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (Calendar) to $obj2 (User)
	...
	public static function doSelectJoinAll(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		CalendarslotPeer::addSelectColumns($criteria);
		$startcol5 = $startcol4 + CalendarslotPeer::NUM_HYDRATE_COLUMNS;
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (Calendar) to the collection in $obj2 (User)
				$obj2->addCalendar($obj1);
			...
			$key4 = CalendarslotPeer::getPrimaryKeyHashFromRow($row, $startcol4);
			if ($key4 !== null) {
				$obj4 = CalendarslotPeer::getInstanceFromPool($key4);
				if (!$obj4) {
					...
					CalendarslotPeer::addInstanceToPool($obj4, $key4);
				} // if obj4 loaded

				// Add the $obj1 (Calendar) to the collection in $obj4 (Calendarslot)
	...
	/**
	 * Selects a collection of Calendar objects pre-filled with all related objects except User.
	 *
	 * @param      Criteria  $criteria
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
